        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Signals_Articles_ArticleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArticleIds = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Exposure = table.Column<decimal>(type: "numeric(5,4)", precision: 5, scale: 4, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Impacts_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Impacts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Impacts_Holdings_HoldingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Impacts_ArticleId",
                table: "Impacts",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_Impacts_HoldingId",
                table: "Impacts",
                column: "HoldingId");

            migrationBuilder.CreateIndex(
                name: "IX_Impacts_ImpactScore",
                table: "Impacts",
                column: "ImpactScore");

            migrationBuilder.CreateIndex(
                name: "IX_Impacts_UserId_ArticleId",
                table: "Impacts",
                columns: new[] { "UserId", "ArticleId" });

            migrationBuilder.CreateIndex(
                name: "IX_Signals_ArticleId",
                table: "Signals",
                column: "ArticleId",
                unique: true);
        }
